...
class part():
    def __init__(self, partSize, root, parentPart=None):
        ...
        self.elementData.extend((0 + elemOffset, 2 + elemOffset, 1 + elemOffset))
        self.elementData.extend((0 + elemOffset, 3 + elemOffset, 2 + elemOffset))
        self.elementData.extend((1 + elemOffset, 3 + elemOffset, 0 + elemOffset))
        self.elementData.extend((2 + elemOffset, 3 + elemOffset, 1 + elemOffset))
